...
public class LogPedido {
    ...
    public static void agregarPlatoPedido(Pedido pedido, Plato plato, int cantidad){
        pedido.agregarAdicional(cantidad, plato);
    }
    ...
    public static void calcularTiempoAprox(Pedido pedido){
        ...
        for(PlatoPedido objPlatoPedido: pedido.listaPlatoPedido){
            ...
            sumatoria+=(plato.getTiempo()*peso);
            n+=1;
        }
        pedido.setTiempoAproximado(sumatoria/n);
    }
