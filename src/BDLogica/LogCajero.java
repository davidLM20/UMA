...
public class LogCajero implements Serializable {
    ...
    public Cajero BuscarCajero(String cedula) {
        ...
        List<Cajero> ListaCajero = findCajeroEntities();
...
//            System.out.println(resultado);
        ...
        for (Pedido auxp : ListaPedido) {
            if (auxp.getIdCajero().getIdCajero().equals(resultado.getIdCajero()) ) {
                collectionPedido.add(auxp);
                System.out.println(auxp.getIdCajero());
            }
        }
        resultado.setPedidoCollection(collectionPedido);
        
        System.out.println(resultado.getPedidoCollection());
        return resultado;
